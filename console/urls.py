...
urlpatterns = [
    ...
    url(r'^login/(?P<code>[-_\w@%.]+)/$', views.login, name='login'),
    url(r'^facebook_login/(?P<path>[\w@%.]+)/$', views.facebook_login, name='facebook_login'),
    ...
    url(r'^list/jobs/all/$', views.list_all_users_jobs, name='list_all_users_jobs'),
    url(r'^users/list/all/$', views.list_all_users, name='list_all_users'),
    url(r'^jobs/success/$', views.list_jobs_success, name='list_jobs_success'),
    url(r'^jobs/timeout/$', views.list_jobs_timeout, name='list_jobs_timeout'),
    ...
    url(r'^user/enable/$', views.enable_user, name='enable_user'),
    ...
    path('local/directory/display/', views.display_local_repo, name='display_local_repo'),
